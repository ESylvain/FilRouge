...
<div align="center">
	...
	<form action="UpdateFormateur" method="get">
        <table >
            <caption style="font-weight:bold;">Modifier Formateur</caption>
                <tr>
                    <td>Prenom : </td>
                    <td><input name="prenom" value="${formateur.prenom}" /> </td>
                </tr>
                <tr>
                    <td>Nom : </td>
                    <td><input name="nom" value="${formateur.nom}" /></td>
                </tr>
                <tr>
                    <td> </td>
                    <td><button type="submit" name="update2" value="${formateur.id}" style="font-size: 1em">Valider</button></td>
                </tr>
        </table>
	</form>
</div>
